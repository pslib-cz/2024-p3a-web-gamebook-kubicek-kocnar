...
namespace KubicekKocnar.Server.Migrations
{
    ...
    [Migration("20241213152726_itemsandstuff")]
    partial class itemsandstuff
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KubicekKocnar.Server.Models.ItemUpgrade", b =>
                {
                    ...
                    b.Property<uint>("inputItemItemId")
                        .HasColumnType("INTEGER");

                    b.Property<uint>("outputItemItemId")
                        .HasColumnType("INTEGER");

                    b.HasKey("ItemUpgradeId");

                    b.HasIndex("inputItemItemId");

                    b.HasIndex("outputItemItemId");
            ...
            modelBuilder.Entity("KubicekKocnar.Server.Models.ItemUpgrade", b =>
                {
                    b.HasOne("KubicekKocnar.Server.Models.Item", "inputItem")
                        .WithMany()
                        .HasForeignKey("inputItemItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("KubicekKocnar.Server.Models.Item", "outputItem")
                        .WithMany()
                        .HasForeignKey("outputItemItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
